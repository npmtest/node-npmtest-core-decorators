...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-core-decorators/node_modules/core-decorators/lib/deprecate.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-core-decorators/node_modules/core-decorators/lib/deprecate.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-core-decorators/node_modules/core-decorators/lib/</a> &#187; deprecate.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    throw new SyntaxError('Only functions can be marked as deprecated');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var methodSignature = target.constructor.name + '#' + key;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  return _extends({}, descriptor, {</span>
    value: <span class="fstat-no" title="function not covered" >function deprecationWrapper() {</span>
<span class="cstat-no" title="statement not covered" >      console.warn('DEPRECATION ' + methodSignature + ': ' + msg);</span>
<span class="cstat-no" title="statement not covered" >      return descriptor.value.apply(this, arguments);</span>
    }
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function deprecate() {</span>
