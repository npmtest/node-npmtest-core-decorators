...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-core-decorators/node_modules/core-decorators/lib/debounce.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-core-decorators/node_modules/core-decorators/lib/debounce.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-core-decorators/node_modules/core-decorators/lib/</a> &#187; debounce.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    throw new SyntaxError('Only functions can be debounced');</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _metaFor = (0, _utils.metaFor)(this),</span>
          debounceTimeoutIds = _metaFor.debounceTimeoutIds;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var timeout = debounceTimeoutIds[key];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      debounceTimeoutIds[key] = setTimeout(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        delete debounceTimeoutIds[key];</span>
<span class="cstat-no" title="statement not covered" >        if (!immediate) {</span>
<span class="cstat-no" title="statement not covered" >          callback.apply(_this, args);</span>
        }
      }, wait);
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function debounce() {</span>
